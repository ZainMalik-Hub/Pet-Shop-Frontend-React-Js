                      ...
                      <div className='shop-item mb-55'>
                        ...
                        <div className='shop-content'>
                          ...
                          <Link
                            ...
                            <h4 style={{ cursor: "pointer" }} className='title'>
                              {v.title}
                            </h4>
                          </Link>
                ...
                <div className='col-lg-4 col-sm-6'>
                  <div className='shop-item mb-55'>
                    ...
                    <div className='shop-content'>
                      <span>Dog toy’s</span>
                      <h4 className='title'>
                        <Link to='/shop-details'>Carriage Dog</Link>
                      </h4>
                      <div className='shop-content-bottom'>
