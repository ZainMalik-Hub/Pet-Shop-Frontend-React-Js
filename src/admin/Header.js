                ...
                <ul className='header-top-social'>
                  ...
                  <li>
                    <a
                      onClick={() =>
                        window.open(
                          "https://www.facebook.com/profile.php?id=100092429717294&mibextid=ZbWKwL",
                          "_blank"
                        )
                      }>
                  ...
                  <li>
                    <a
                      onClick={() =>
                        window.open(
                          "https://instagram.com/official.vetcare?igshid=ZGUzMzM3NWJiOQ==",
                          "_blank"
                        )
                      }>
                  ...
                  <li>
                    <a
                      onClick={() =>
                        window.open(
                          "https://www.linkedin.com/in/vetcare-pet-shop-b079b1276",
                          "_blank"
                        )
                      }>
            ...
            <div className='col-12'>
              ...
              <div className='menu-wrap'>
                <nav className='menu-nav show'>
                  <div className='logo'>
                    <Link to='/'>
                      <img src={logo} alt='helo' style={{ height: 100 }} />
                    </Link>
                  </div>
                  <div className='navbar-wrap main-menu d-none d-lg-flex'>
                    <ul className='navigation'>
                      <li className='active menu-item-has-children'>
                        <Link to='/admin-home' onClick={(e) => handleActive(e)}>
                          Home
                        </Link>
                      </li>
                      {/* <li>
